  ...
  useEffect(() => {
    const fetchPaymentMethods = async () => {
      try {
        setLoading(true);
        setError(null);
        const response = await axios.get('https://backendd-q0zc.onrender.com/api/registrocatalogopagos/list');
    ...
    if (selectedMethod === methodProperties["Mercado Pago"].id) {
      ...
      try {
        const response = await axios.post(
          "https://backendd-q0zc.onrender.com/api/mercadopago/crear-preferencia",
          {
            id_usuario,
            id_habitacion,
            id_hotel,
