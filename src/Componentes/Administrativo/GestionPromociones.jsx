...
const GestionPromociones = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [promocionesRes, statsRes] = await Promise.all([
          axios.get('https://backendd-q0zc.onrender.com/api/gestionpromocionesadmin/list'),
          axios.get('https://backendd-q0zc.onrender.com/api/gestionpromocionesadmin/stats'),
        ]);
  ...
  const handleDelete = async (id, estado) => {
    ...
    try {
      const response = await axios.delete(`https://backendd-q0zc.onrender.com/api/gestionpromocionesadmin/delete/${id}`);
