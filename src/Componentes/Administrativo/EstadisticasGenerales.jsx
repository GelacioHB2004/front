    ...
    const fetchData = async () => {
      try {
        ...
        const [statsRes, reservationRes, userTypeRes, hotelsRes] = await Promise.all([
          axios.get('https://backendd-q0zc.onrender.com/api/gestionestadisticasadmin/general-stats'),
          axios.get('https://backendd-q0zc.onrender.com/api/gestionestadisticasadmin/reservation-data'),
          axios.get('https://backendd-q0zc.onrender.com/api/gestionestadisticasadmin/user-type-data'),
          axios.get('https://backendd-q0zc.onrender.com/api/gestionestadisticasadmin/top-hotels'),
        ]);
